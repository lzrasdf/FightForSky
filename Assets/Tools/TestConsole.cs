...
{  
    ...
    {  
        ...
        public bool refresh_file = false; 
        ...
        const int margin = 20;  
        static readonly GUIContent clearLabel = new GUIContent("Clear(将清除当前日志记录)", "Clear the contents of the console.");  
